...
void InnerRuleWidget::onGroupListItemSelected(QListWidgetItem* item) {
	if (item) {
...
bool InnerRuleWidget::InitAgentManMVCFW() {
...
bool InnerRuleWidget::UpdateGroupInfo() {
	initGroupInfo();
	return true;
}

bool InnerRuleWidget::UpdateGroupInfo(long nGroupID, std::string strGroupName) {
...
bool InnerRuleWidget::DeleteGroupInfo(long nGroupID) {
...
void InnerRuleWidget::initGroupInfo() {
	...
	connect(ui->groupListWidget, &QListWidget::itemClicked, this, &InnerRuleWidget::onGroupListItemSelected);
}


void InnerRuleWidget::ClearListWidget(QListWidget* listWidget) {
