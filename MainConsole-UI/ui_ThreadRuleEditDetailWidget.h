...
public:
    ...
    void setupUi(QWidget *ThreadRuleEditDetailWidget)
    {
        ...
        ThreadRuleEditDetailWidget->resize(650, 300);
        ...
        pushButton = new QPushButton(ThreadRuleEditDetailWidget);
        ...
        comboBox = new QComboBox(ThreadRuleEditDetailWidget);
        comboBox->setObjectName(QString::fromUtf8("comboBox"));
        comboBox->setGeometry(QRect(115, 50, 105, 26));
        comboBox_2 = new QComboBox(ThreadRuleEditDetailWidget);
        comboBox_2->setObjectName(QString::fromUtf8("comboBox_2"));
        comboBox_2->setGeometry(QRect(115, 80, 105, 26));
        comboBox_3 = new QComboBox(ThreadRuleEditDetailWidget);
        comboBox_3->setObjectName(QString::fromUtf8("comboBox_3"));
        comboBox_3->setGeometry(QRect(115, 110, 105, 26));
        lineEdit = new QLineEdit(ThreadRuleEditDetailWidget);
        lineEdit->setObjectName(QString::fromUtf8("lineEdit"));
        lineEdit->setGeometry(QRect(225, 50, 405, 27));
        lineEdit_2 = new QLineEdit(ThreadRuleEditDetailWidget);
        lineEdit_2->setObjectName(QString::fromUtf8("lineEdit_2"));
        lineEdit_2->setGeometry(QRect(225, 80, 405, 27));
        ...
        label_6->setGeometry(QRect(230, 110, 81, 31));
        comboBox_4 = new QComboBox(ThreadRuleEditDetailWidget);
        comboBox_4->setObjectName(QString::fromUtf8("comboBox_4"));
        comboBox_4->setGeometry(QRect(310, 110, 110, 26));
        label_7 = new QLabel(ThreadRuleEditDetailWidget);
        label_7->setObjectName(QString::fromUtf8("label_7"));
        label_7->setGeometry(QRect(440, 110, 81, 31));
        comboBox_5 = new QComboBox(ThreadRuleEditDetailWidget);
        comboBox_5->setObjectName(QString::fromUtf8("comboBox_5"));
        comboBox_5->setGeometry(QRect(520, 110, 110, 26));
        textEdit = new QTextEdit(ThreadRuleEditDetailWidget);
        textEdit->setObjectName(QString::fromUtf8("textEdit"));
        textEdit->setGeometry(QRect(115, 140, 515, 85));
        checkBox = new QCheckBox(ThreadRuleEditDetailWidget);
    ...
    void retranslateUi(QWidget *ThreadRuleEditDetailWidget)
    {
        ...
        closeBtn->setText(QApplication::translate("ThreadRuleEditDetailWidget", "X", nullptr));
        label->setText(QApplication::translate("ThreadRuleEditDetailWidget", "\347\272\277\347\250\213\350\247\204\345\210\231", nullptr));
        pushButton->setText(QApplication::translate("ThreadRuleEditDetailWidget", "\346\267\273\345\212\240", nullptr));
        ...
        checkBox->setText(QApplication::translate("ThreadRuleEditDetailWidget", "\344\270\212\346\212\245\346\227\245\345\277\227", nullptr));
    } // retranslateUi
