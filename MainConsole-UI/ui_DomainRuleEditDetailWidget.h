...
public:
    ...
    void setupUi(QWidget *DomainRuleEditDetailWidget)
    {
        ...
        closeBtn->setGeometry(QRect(700, 0, 40, 31));
        QFont font;
        ...
        pushButton = new QPushButton(DomainRuleEditDetailWidget);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(620, 250, 112, 37));
        ...
        comboBox = new QComboBox(DomainRuleEditDetailWidget);
        comboBox->setObjectName(QString::fromUtf8("comboBox"));
        comboBox->setGeometry(QRect(105, 50, 105, 26));
        comboBox_3 = new QComboBox(DomainRuleEditDetailWidget);
        comboBox_3->setObjectName(QString::fromUtf8("comboBox_3"));
        comboBox_3->setGeometry(QRect(105, 110, 105, 26));
        lineEdit = new QLineEdit(DomainRuleEditDetailWidget);
        lineEdit->setObjectName(QString::fromUtf8("lineEdit"));
        lineEdit->setGeometry(QRect(215, 50, 511, 27));
        lineEdit_2 = new QLineEdit(DomainRuleEditDetailWidget);
        lineEdit_2->setObjectName(QString::fromUtf8("lineEdit_2"));
        lineEdit_2->setGeometry(QRect(105, 80, 621, 27));
        ...
        label_6->setGeometry(QRect(220, 110, 81, 31));
        comboBox_4 = new QComboBox(DomainRuleEditDetailWidget);
        comboBox_4->setObjectName(QString::fromUtf8("comboBox_4"));
        comboBox_4->setGeometry(QRect(300, 110, 110, 26));
        label_7 = new QLabel(DomainRuleEditDetailWidget);
        label_7->setObjectName(QString::fromUtf8("label_7"));
        label_7->setGeometry(QRect(430, 110, 81, 31));
        comboBox_5 = new QComboBox(DomainRuleEditDetailWidget);
        comboBox_5->setObjectName(QString::fromUtf8("comboBox_5"));
        comboBox_5->setGeometry(QRect(510, 110, 110, 26));
        textEdit = new QTextEdit(DomainRuleEditDetailWidget);
        textEdit->setObjectName(QString::fromUtf8("textEdit"));
        textEdit->setGeometry(QRect(105, 140, 621, 85));
        checkBox = new QCheckBox(DomainRuleEditDetailWidget);
    ...
    void retranslateUi(QWidget *DomainRuleEditDetailWidget)
    {
        ...
        closeBtn->setText(QApplication::translate("DomainRuleEditDetailWidget", "X", nullptr));
        label->setText(QApplication::translate("DomainRuleEditDetailWidget", "\345\237\237\345\220\215\350\247\204\345\210\231", nullptr));
        pushButton->setText(QApplication::translate("DomainRuleEditDetailWidget", "\346\267\273\345\212\240", nullptr));
        ...
        checkBox->setText(QApplication::translate("DomainRuleEditDetailWidget", "\344\270\212\346\212\245\346\227\245\345\277\227", nullptr));
    } // retranslateUi
