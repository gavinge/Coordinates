...
public:
    ...
    void setupUi(QWidget *ModuleRuleEditDetailWidget)
    {
        ...
        ModuleRuleEditDetailWidget->resize(650, 300);
        ...
        pushButton = new QPushButton(ModuleRuleEditDetailWidget);
        ...
        comboBox = new QComboBox(ModuleRuleEditDetailWidget);
        comboBox->setObjectName(QString::fromUtf8("comboBox"));
        comboBox->setGeometry(QRect(115, 50, 105, 26));
        comboBox_2 = new QComboBox(ModuleRuleEditDetailWidget);
        comboBox_2->setObjectName(QString::fromUtf8("comboBox_2"));
        comboBox_2->setGeometry(QRect(115, 80, 105, 26));
        comboBox_3 = new QComboBox(ModuleRuleEditDetailWidget);
        comboBox_3->setObjectName(QString::fromUtf8("comboBox_3"));
        comboBox_3->setGeometry(QRect(115, 110, 105, 26));
        lineEdit = new QLineEdit(ModuleRuleEditDetailWidget);
        lineEdit->setObjectName(QString::fromUtf8("lineEdit"));
        lineEdit->setGeometry(QRect(225, 50, 405, 27));
        lineEdit_2 = new QLineEdit(ModuleRuleEditDetailWidget);
        ...
        comboBox_4 = new QComboBox(ModuleRuleEditDetailWidget);
        ...
        comboBox_5 = new QComboBox(ModuleRuleEditDetailWidget);
        comboBox_5->setObjectName(QString::fromUtf8("comboBox_5"));
        comboBox_5->setGeometry(QRect(520, 110, 110, 26));
        textEdit = new QTextEdit(ModuleRuleEditDetailWidget);
        textEdit->setObjectName(QString::fromUtf8("textEdit"));
        textEdit->setGeometry(QRect(115, 140, 515, 85));
        checkBox = new QCheckBox(ModuleRuleEditDetailWidget);
    ...
    void retranslateUi(QWidget *ModuleRuleEditDetailWidget)
    {
        ...
        closeBtn->setText(QApplication::translate("ModuleRuleEditDetailWidget", "X", nullptr));
        label->setText(QApplication::translate("ModuleRuleEditDetailWidget", "\346\250\241\345\235\227\350\247\204\345\210\231", nullptr));
        pushButton->setText(QApplication::translate("ModuleRuleEditDetailWidget", "\346\267\273\345\212\240", nullptr));
        ...
        checkBox->setText(QApplication::translate("ModuleRuleEditDetailWidget", "\344\270\212\346\212\245\346\227\245\345\277\227", nullptr));
    } // retranslateUi
